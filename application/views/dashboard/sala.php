<?php
include("application/views/dashboard/consumoAPI.php");
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="container mt-4">
    ...
    <a href="<?php echo site_url('dashboard'); ?>" class="btn btn-secondary mt-3">Regresar</a></div>
        ...
        <div id="contenedor" class="text-center">
        <h4 class="text-danger">Te cuento sobre los datos Meteorológicos del día</h4>
        <?php
            echo "Temperatura actual: " . $current_temperature . "°C<br>";
            echo "Temperatura máxima hoy: " . $daily_max_temp . "°C";
            ?>
    </div>
